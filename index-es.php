    ...
    <div class="intro-container">
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p><h3 style="color: white">Sustentabilidade en Tecnología</h3></p>
                  <p>Somos una criptomoneda sostenible que tiene como objetivo reducir las diferencias sociales y económicas de la población mundial.
                </p>
        ...
        <div class="carousel-item"> 
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p><h3 style="color: white">¡La billetera móvil que mina stake!</h3></p>
                  <p>¡Tenemos la única billetera Android en Brasil que realiza minería PoS directamente en el teléfono inteligente usando la misma estructura que las billeteras de escritorio!
                </p>
        ...
        <div class="carousel-item"> 
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>Comprar y vender de forma fácil</h2>
                <p><h3 style="color: white">Compra y vende SPERO oficialmente</h3></p>
                  <p>¡Con nuestra plataforma de compra y venta SPERO, tiene más confianza sobre el origen y el destino de sus activos! Acceda ahora!
                </p>
                <a href="https://speropay.sperocoin.org" class="btn-get-started scrollto" target="_blank">ACCESO!</a>
              </div>
            </div>
          </div>
  ...
  <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><center>Wallet Android. Con esta wallet, podrás realizar mineración PoS directamente desde tu celular/tablet.<br>
            <br>
...
<div class="modal fade" id="androidlite" role="dialog">
  <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><center>Wallet Android WebBased. Conectada directamente a nuestra WebWallet, así que tienes la comodidad de acceder a tu cuenta en la palma de tu mano..<br>
            <br>
...
<div class="modal fade" id="windowsqt" role="dialog">
  <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><center>Wallet designer con gráfico. Modelo para aquellos que buscan confort y conveniencia para verificar saldo, enviar y recibir monedas de forma prática y rápida.<br>
            <br>
...
<div class="modal fade" id="windowsdaemon" role="dialog">
  <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><center>Wallet designer sin graficos.  Modelo para aquellos que buscan praticidad y menor consumo de recursos.<br>
            <br>
...
<div class="modal fade" id="blockchain" role="dialog">
  <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p><center>Baje la cadena de bloques completa en una fecha mas reciente para mejorar la velocidad de la sincronización.<br>
            <br>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
            <h4 class="title"><a href="">Servicios oficiales</a></h4>
            <p class="description">
              Contamos con desarrolladores que producen aplicaciones y sitios web oficiales, que ofrecen seguridad, transparencia y velocidad en su ejecución.
            </p>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-delay="0.1s" data-wow-duration="1.4s">
...
<br></p>
    ...
    <div class="card">
        ...
        <div id="11032019" class="collapse">
          <div class="card-body">
              <p><i class="fa fa-check-square-o" aria-hidden="true"></i> [RPC] Implementación del comando -zapwallettxes y del sistema FILE_DESCRIPTORS
<br></p>
        </div>
      </div>
  </div>
    ...
    <div class="card">
        ...
        <div id="16032019" class="collapse">
          <div class="card-body">
              <p><i class="fa fa-check-square-o" aria-hidden="true"></i> Copias de seguridad automáticas del archivo wallet.dat<br></p>
        </div>
      </div>
  </div>
    ...
    <div class="card">
        ...
        <div id="09042019" class="collapse">
          <div class="card-body">
              <p><i class="fa fa-check-square-o" aria-hidden="true"></i> Activación de la cuenta de base SPERO en PoW<br></p>
        </div>
      </div>
  </div>
    ...
    <div class="card">
        ...
        <div id="17042019" class="collapse">
          <div class="card-body">
              <p><i class="fa fa-check-square-o" aria-hidden="true"></i> Adición del sistema Charity PoS<br></p>
        </div>
      </div>
  </div>
    ...
    <div class="card">
        ...
        <div id="22052019" class="collapse">
          <div class="card-body">
              <p><i class="fa fa-check-square-o" aria-hidden="true"></i> Lanzamiento de la versión 2.6.4.7<br></p>
        <br></p>
        </div>
      </div>
  </div>
...
<div id="infogeneral" class="collapse">
    ...
    <div class="card">
        ...
        <div id="24052019" class="collapse">
          <div class="card-body">
              <p><i class="fa fa-check-square-o" aria-hidden="true"></i> Listado en <a href="https://app.troca.ninja/detail/SPERO">Troca.Ninja</a></p>
        </div>
      </div>
  </div>
