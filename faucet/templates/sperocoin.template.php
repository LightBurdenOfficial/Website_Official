...
<head>
    ...
    <!-- Default CSS -->
    <link rel="stylesheet" href="https://sperocoin.ddns.net/faucet/templates/default1.css" type="text/css" />
...
<img src="https://sperocoin.ddns.net/faucet/templates/img/sperocoin.png" width="80px" style="padding-bottom: 5%"><font class="titulo">{{TITLE}}</font>
</div></div>
...
<center><div class="panel panel-default">
    ...
    <form method="post" action="">
        ...
        <center><div class="margintop" id="captcha">{{CAPTCHA}}</div>
        <input id="send" name="dogecoin_submit" type="submit" class="btn btn-warning btn-md margintop" value="Send {{COINNAME}}" /></center>
    </form>
