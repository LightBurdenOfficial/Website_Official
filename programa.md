...
## 1. Inscrição dos usuários<br>
1.1 - Os usuários deverão se inscrever via formulário, que se encontra disponível no site [SperoGame](https://sperocoin.org/sperogame/quiz).<br>
...
1.3 - Após o preenchimento do formulário os usuários passarão por um sorteio ao vivo no Canal Oficial da SPERO no [Youtube](https://youtube.com/c/SperoCoin), onde 10 serão selecionados para participação efetiva e 10 usuários para o banco de reservas.<br>

## 2. Chamada dos participantes
2.1 - Após a seleção, no sábado às 20h todos os 10 usuários selecionados participarão de um evento que será transmitido em um canal do [`Hangouts`](https://hangouts.google.com/?hl=pt-BR) exclusivo para o evento. O link será disponibilizado 1 dia antes do evento.<br>
<br>
...
<br>
2.1 - Serão então liberadas perguntas de modo desclassificatório, de acordo com os próximos itens.<br>
...
4.1.4 - Usuários com menor número de pontos na rodada serão desclassificados.
<br>
...
4.1.6 - Usuários que não se apresentarem no link disponibilizado para o grupo do Hangouts restando 15 minutos antes do evento, serão desclassificados, entrando em seu lugar o próximo usuário do banco de reservas.<br>
...
4.2.3 - A pergunta será realizada de forma ditada pelo apresentador e posteriormente será exibida no YouTube, assim que a exibição for iniciada no Youtube, cada usuário terá o prazo de 15 segundos para responder. Caso o usuário não responda, sua resposta será considerada nula, tendo seu valor de pontos zerado.<br>
4.2.4 - Usuários com menor número de pontos na rodada serão desclassificados.<br>
<br>
...
4.2.6 - Usuários que não se apresentarem no link disponibilizado para o grupo do Hangouts restando 15 minutos antes do evento, serão desclassificados, entrando em seu lugar o próximo usuário do banco de reservas.<br>
...
4.3.3 - A pergunta será realizada de forma ditada pelo apresentador e posteriormente será exibida no YouTube, assim que a exibição for iniciada no Youtube, cada usuário terá o prazo de 15 segundos para responder. Caso o usuário não responda, sua resposta será considerada nula, tendo seu valor de pontos zerado.<br>
4.3.4 - Usuários com menor número de pontos na rodada serão desclassificados.<br>
...
4.3.6 - Usuários que não se apresentarem no link disponibilizado para o grupo do Hangouts restando 15 minutos antes do evento, serão desclassificados, entrando em seu lugar o próximo usuário do banco de reservas.<br>
...
5.1.3 - A pergunta será realizada de forma ditada pelo apresentador e posteriormente será exibida no YouTube, assim que a exibição for iniciada no Youtube, cada usuário terá o prazo de 15 segundos para responder. Caso o usuário não responda, sua resposta será considerada nula, tendo seu valor de pontos zerado.<br>
5.1.4 - Usuários com menor número de pontos na rodada serão desclassificados.<br>
<br>
...
5.1.6 - Usuários que não se apresentarem no link disponibilizado para o grupo do Hangouts restando 15 minutos antes do evento, serão desclassificados, entrando em seu lugar o próximo usuário do banco de reservas.<br>
...
5.2.3 - A pergunta será realizada de forma ditada pelo apresentador e posteriormente será exibida no YouTube, assim que a exibição for iniciada no Youtube, cada usuário terá o prazo de 15 segundos para responder. Caso o usuário não responda, sua resposta será considerada nula, tendo seu valor de pontos zerado.<br>
5.2.4 - Usuários com menor número de pontos na rodada serão desclassificados.<br>
<br>
...
5.2.6 - Usuários que não se apresentarem no link disponibilizado para o grupo do Hangouts restando 15 minutos antes do evento, serão desclassificados, entrando em seu lugar o próximo usuário do banco de reservas.<br>
...
5.3.3 - A pergunta será realizada de forma ditada pelo apresentador e posteriormente será exibida no YouTube, assim que a exibição for iniciada no Youtube, cada usuário terá o prazo de 15 segundos para responder. Caso o usuário não responda, sua resposta será considerada nula, tendo seu valor de pontos zerado.<br>
5.3.4 - Usuários com menor número de pontos na rodada serão desclassificados.<br>
<br>
...
5.3.6 - Usuários que não se apresentarem no link disponibilizado para o grupo do Hangouts restando 15 minutos antes do evento, serão desclassificados, entrando em seu lugar o próximo usuário do banco de reservas.<br>
...
6.1.3 - A pergunta será realizada de forma ditada pelo apresentador e posteriormente será exibida no YouTube, assim que a exibição for iniciada no Youtube, cada usuário terá o prazo de 15 segundos para responder. Caso o usuário não responda, sua resposta será considerada nula, tendo seu valor de pontos zerado.<br>
6.1.4 - Usuários com menor número de pontos na rodada serão desclassificados.<br>
<br>
...
6.1.6 - Usuários que não se apresentarem no link disponibilizado para o grupo do Hangouts restando 15 minutos antes do evento, serão desclassificados, entrando em seu lugar o próximo usuário do banco de reservas.<br>
...
6.2.3 - A pergunta será realizada de forma ditada pelo apresentador e posteriormente será exibida no YouTube, assim que a exibição for iniciada no Youtube, cada usuário terá o prazo de 15 segundos para responder. Caso o usuário não responda, sua resposta será considerada nula, tendo seu valor de pontos zerado.<br>
6.2.4 - Usuários com menor número de pontos na rodada serão desclassificados.<br>
<br>
...
6.2.6 - Usuários que não se apresentarem no link disponibilizado para o grupo do Hangouts restando 15 minutos antes do evento, serão desclassificados, entrando em seu lugar o próximo usuário do banco de reservas.<br>
...
7.1.3 - A pergunta será realizada de forma ditada pelo apresentador e posteriormente será exibida no YouTube, assim que a exibição for iniciada no Youtube, cada usuário terá o prazo de 15 segundos para responder. Caso o usuário não responda, sua resposta será considerada nula, tendo seu valor de pontos zerado.<br>
7.1.4 - Usuários com menor número de pontos na rodada serão desclassificados.<br>
<br>
...
7.1.6 - Usuários que não se apresentarem no link disponibilizado para o grupo do Hangouts restando 15 minutos antes do evento, serão desclassificados, entrando em seu lugar o próximo usuário do banco de reservas.<br>
...
8.1.3 - A pergunta será realizada de forma ditada pelo apresentador e posteriormente será exibida no YouTube, assim que a exibição for iniciada no Youtube, cada usuário terá o prazo de 15 segundos para responder. Caso o usuário não responda, sua resposta será considerada nula, tendo seu valor de pontos zerado.<br>
8.1.4 - Usuários com menor número de pontos na rodada serão desclassificados.<br>
...
8.1.6 - Usuários que não se apresentarem no link disponibilizado para o grupo do Hangouts restando 15 minutos antes do evento, serão desclassificados, entrando em seu lugar o próximo usuário do banco de reservas.<br>
...
Perguntar ao Chat: Nessa modalidade a pergunta será direcionada para o chat do Youtube e os usuários terão o prazo de 20 segundos para responderem, após o término do tempo, o participante terá 10 segundos para fazer a escolha da resposta.
